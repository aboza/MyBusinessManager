...
public final class Constants {
    ...
    public static String ORACLE_GET_ALL_RECEIPTS = "SELECT RECEIPT_ID,CUSTOMER_ID,RECEIPT_DATE,RECEIPT_NUMBER,PAYMENT_METHOD,"
            +"OBSERVATIONS,DISCOUNT,TAX,TOTAL,SUBTOTAL,POSTED FROM BM_RECEIPTS";
    public static String ORACLE_GET_RECEIPT_BY_RECEIPT_ID = "SELECT RECEIPT_ID,CUSTOMER_ID,RECEIPT_DATE,RECEIPT_NUMBER,"
            +"PAYMENT_METHOD,OBSERVATIONS,DISCOUNT,TAX,TOTAL,SUBTOTAL,POSTED FROM BM_RECEIPTS WHERE RECEIPT_ID = ?";
    public static String ORACLE_GET_RECEIPT_DETAILS_BY_RECEIPT_ID = "SELECT RECEIPT_DETAIL_ID,ITEM_ID,RECEIPT_ID,"
            +"QUANTITY,TAX,COST,TOTAL_AMOUNT,DISCOUNT FROM BM_RECEIPT_DETAILS WHERE RECEIPT_ID = ?";
    public static String ORACLE_GET_ITEM_BY_ITEM_ID = "SELECT ITEM_ID,NAME,CODE,DESCRIPTION,COST_PER_UNIT,"
            +"REORDER_POINT,ON_HAND FROM BM_ITEMS WHERE ITEM_ID = ?";
