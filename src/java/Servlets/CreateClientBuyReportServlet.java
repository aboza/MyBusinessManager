 ...
 * @author GENERAL
 */
@WebServlet(name = "CreateClientBuyReportServlet", urlPatterns = {"/CreateClientBuyReportServlet"})
public class CreateClientBuyReportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader("Content-Disposition","attachment; filename=ReporteDeComprasDelCliente.pdf");
