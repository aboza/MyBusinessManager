 ...
 * @author GENERAL
 */
@WebServlet(name = "CreateProductsReportServlet", urlPatterns = {"/CreateProductsReportServlet"})
public class CreateProductsReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader("Content-Disposition","attachment; filename=InventarioDeProductos.pdf");
