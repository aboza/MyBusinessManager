                ...
                <div class="row">
                    <div class="4u" id="sidebar">
                        <section>
                            ...
                            <a href="DiscCreateServlet" class="button">Proveedores</a>
                            <header>
                            ...
                            <a href="DiscCreateServlet" class="button">Clientes</a>
                            <header>
                            ...
                            <a href="DiscCreateServlet" class="button">Facturación</a>
                            ...
                            <a href="DiscCreateServlet" class="button">Seguridad</a>
                    ...
                    <div class="8u skel-cell-important" id="content">
                        <div>
                            <a href="ProfileEditServlet">Editar</a>
                            <a href="DeactivateAccountServlet"> |Desactivar</a>
                        </div>
                        <article id="main">
