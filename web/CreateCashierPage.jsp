<%-- 
    Document   : CreateCashierPage
    Created on : 21-jun-2015, 3:56:53
    Author     : Glenn
--%>
                ...
                <div class="row">
                    ...
                    <div class="8u skel-cell-important" id="content">
                        <article id="main">
                            ...
                            <form method="post" action="CreateCashierServlet">    
                                <% String error = "";
                                ...
                                <h1>Nombre</h1>
                                <input class="longtext" name="cashierName" id="cashierName" >
